...
const emptyForm: GymFormState = {
  ...
  const { gyms, loading, error, form, setForm, editForm, setEditForm, selectedGymId, setSelectedGymId, saving, updating, uploading, featuring, verifying, consentSaving, customAmenity, setCustomAmenity, customEditAmenity, setCustomEditAmenity, existingConsent, showAddForm, setShowAddForm, boostGym, setBoostGym, paymentsEnabled, onboardingSteps, onboardingProgress } = useOwnerGymLogic();
